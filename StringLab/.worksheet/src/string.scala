...
object string {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(84); 
  ...
  isPal("Atta");System.out.println("""res4: Boolean = """ + $show(res$4));$skip(190); 
  ...
  isPal2("i t%une   , eiNU(((T---i");System.out.println("""res7: Boolean = """ + $show(res$7));$skip(111); 
  ...
  val a4 = mkWord(20);System.out.println("""a4  : String = """ + $show(a4 ));$skip(202); 
  ...
  mkSentence(8);System.out.println("""res10: String = """ + $show(res$10));$skip(237); 
  ...
  def isSpace(c: Char) = c == '\n' || c == '\t' || c == ' ';System.out.println("""isSpace: (c: Char)Boolean""");$skip(835); 
  ...
  };System.out.println("""eval: (str: String)Double""");$skip(35); val res$11 = 
  ...
  {
  	case e: Exception => println(e)
  };System.out.println("""res14: AnyVal = """ + $show(res$14));$skip(57); 
